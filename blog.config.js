...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'b78676201b634a07815da5c1b324009f',
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个向往Rust、C++和Go的家伙👾, Hi，我是一个干饭人🦤, 欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'axiszql', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '喜欢Rust、C++和Go的家伙!🐧', // 作者简介
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/sekiro0x', // 你的github个人主页 例如 https://github.com/tangly1024
